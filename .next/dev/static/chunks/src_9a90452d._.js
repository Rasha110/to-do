...
function ProtectedLayout({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProtectedLayout.useEffect": ()=>{
            const checkUser = {
                "ProtectedLayout.useEffect.checkUser": async ()=>{
            ...
            }["ProtectedLayout.useEffect.checkUser"];
            checkUser();
            const { data: listener } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange({
                "ProtectedLayout.useEffect": (_, session)=>{
    ...
    const handleLogout = async ()=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signOut();
        router.push("/signin");
    };
...
_s(ProtectedLayout, "77ryw3CXO5/KkovpmD9ldYrxLT0=", false, function() {
    return [
...
//# sourceMappingURL=src_9a90452d._.js.map