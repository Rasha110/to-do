...
"[project]/src/app/(auth)/auth/AuthForm.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuthForm({ mode }) {
    ...
    const schema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$schema$2f$schema$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAuthSchema"])(mode);
    ...
    const onSubmit = async (data)=>{
        try {
            if (mode === "signup") {
                const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$supabase$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
                    email: data.email,
                ...
                const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$supabase$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                    email: data.email,
                    password: data.password
                });
                if (error) throw error;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c043e83b._.js.map